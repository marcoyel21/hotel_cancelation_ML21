...
#dataframe
RF <- data.frame(test_id, pred_rf$predictions)
colnames(RF) <- c('id','proby0','prob')
RF$proby0<-NULL
write.csv(RF,"submission.csv",row.names = F)
