...
ESTA PARTE DEBEMOS LIMPIARLA Y MEJORARLA Y SOLO HACRTLA PARA TRAIUNING
...
En esta parte convertimos el **data frame** en una matriz esparsa en la que cada categoría de cada variable se convierte en una columna.
...
Los modelos ganadores aprovechan las matrices ralas por la rapidez con la que se puede entrenar y experimentar.
...
Debido a la alta cantidad de variables de las bases de datos (y pues que muchas son poco informativas) el colsample por cada arbol generado es alto: del 70%. 
